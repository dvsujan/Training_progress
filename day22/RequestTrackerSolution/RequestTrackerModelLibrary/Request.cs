...
namespace RequestTrackerModelLibrary
{
    public class Request
    {
        ...
        {
            return $"Request Number: {RequestNumber}, Request Message: {RequestMessage}, Request Date: {RequestDate}, Closed Date: {ClosedDate}, Request Status: {RequestStatus}, Request Raised By: {RequestRaisedBy}, Request Closed By: {RequestClosedBy}";
        }
    }
}
