...
namespace RequestTrackerModelLibrary
{
    public class RequestSolution
    {
        ...
        {
            return $"Solution Id: {SolutionId}, Request Id: {RequestId}, Solution Description: {SolutionDescription}, Solved By: {SolvedBy}, Solved Date: {SolvedDate}, Is Solved: {IsSolved}, Request Raiser Comment: {RequestRaiserComment}";
        }
    }
}
