...
namespace ShoppingRepositoryTest
{
    public class CartItemRepoTest
    {
        ...
        {
            Assert.Throws<NoCartItemWithGivenIdException>(() => cartItemRepo.Update(new CartItem { CartId = 2, ProductId = 1, Quantity = 1, Price = 100, Discount = 10, PriceExpiryDate = DateTime.Now.AddDays(1) }));
        }
    }
}
