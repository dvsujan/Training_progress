    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<RequestTrackerContext>(
                options=>options.UseSqlServer("Data Source=794GBX3\\INSTANCE_1;Integrated Security=true;Initial Catalog=EmpTrackerApi;TrustServerCertificate=True")
                );
            #endregion
            #region repositories
            ...
            builder.Services.AddScoped<IReposiroty<int,SolutionFeedback> , SolutionFeedbackRepository>();
            builder.Services.AddScoped<IReposiroty<int,RequestSolution> , RequestSolutionRepository>();
            #endregion
